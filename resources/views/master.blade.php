	...
	<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark" style="min-height: 10vh">
		<div class="container-fluid">
			<a class="navbar-brand" href="/">
				<img src="{{ asset('storage/assets/logo.png') }}" alt="logo" class="img-fluid" style="max-height: 6vh"><span class="text-light fw-bold ms-2">i</span><span class="text-primary">nterconnec</span><span class="text-light fw-bold">T</span><span class="text-primary">hor</span>
			</a>						
