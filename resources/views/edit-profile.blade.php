                ...
                <div class="col-md-10">
                    ...
                    <form action="{{ route('user.updateProfile') }}" method="POST" enctype="multipart/form-data" class="p-3 border rounded">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" id="first_name" name="first_name" placeholder="Enter your first name" value="{{ $user->first_name }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="last_name">Last Name</label>
                            <input type="text" class="form-control mb-3" id="last_name" name="last_name" placeholder="Enter your last name" value="{{ $user->last_name }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="name">Username</label>
                            <input type="text" class="form-control mb-3" id="name" name="name" placeholder="Enter your username" value="{{ $user->name }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="email">Email address</label>
                            <input type="email" class="form-control mb-3" id="email" name="email" placeholder="Enter your email" value="{{ $user->email }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="phone">Phone</label>
                            <input type="tel" class="form-control mb-3" id="phone" name="phone" placeholder="Enter your phone number" value="{{ $user->phone }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="street_nr">Street + Number</label>
                            <input type="text" class="form-control mb-3" id="street_nr" name="street_nr" placeholder="Enter your street and number" value="{{ $user->street_nr }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="postal_code">Postal Code</label>
                            <input type="number" class="form-control mb-3" id="postal_code" name="postal_code" placeholder="Enter your postal code" value="{{ $user->postal_code }}" required>
                        </div>

                        <div class="form-group">
                            <label class="mb-1 fw-bold text-primary" for="city">City</label>
                            <input type="text" class="form-control mb-3" id="city" name="city" placeholder="Enter your city" value="{{ $user->city }}" required>
                        </div>
                        ...
                        {{-- license and agreement checkbox --}}
                        <div class="form-group">
